 ...
 */
final class Version20190107180159 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__producer AS SELECT id, first_name, last_name FROM producer');
        $this->addSql('DROP TABLE producer');
        $this->addSql('CREATE TABLE producer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO producer (id, first_name, last_name) SELECT id, first_name, last_name FROM __temp__producer');
        $this->addSql('DROP TABLE __temp__producer');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_976449DCA9D1C132C808BA5A ON producer (first_name, last_name)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__actor AS SELECT id, first_name, last_name FROM actor');
        $this->addSql('DROP TABLE actor');
        $this->addSql('CREATE TABLE actor (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO actor (id, first_name, last_name) SELECT id, first_name, last_name FROM __temp__actor');
        $this->addSql('DROP TABLE __temp__actor');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_447556F9A9D1C132C808BA5A ON actor (first_name, last_name)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_447556F9A9D1C132C808BA5A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__actor AS SELECT id, first_name, last_name FROM actor');
        $this->addSql('DROP TABLE actor');
        $this->addSql('CREATE TABLE actor (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO actor (id, first_name, last_name) SELECT id, first_name, last_name FROM __temp__actor');
        $this->addSql('DROP TABLE __temp__actor');
        $this->addSql('DROP INDEX IDX_BB8FA69310DAF24A');
        $this->addSql('DROP INDEX IDX_BB8FA693567F5183');
        ...
        $this->addSql('CREATE INDEX IDX_8B4CAD16446F285F ON films_studios (studio_id)');
        $this->addSql('CREATE INDEX IDX_8B4CAD16567F5183 ON films_studios (film_id)');
        $this->addSql('DROP INDEX UNIQ_976449DCA9D1C132C808BA5A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__producer AS SELECT id, first_name, last_name FROM producer');
        $this->addSql('DROP TABLE producer');
        $this->addSql('CREATE TABLE producer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO producer (id, first_name, last_name) SELECT id, first_name, last_name FROM __temp__producer');
        $this->addSql('DROP TABLE __temp__producer');
        $this->addSql('DROP INDEX IDX_794381C6F675F31B');
        $this->addSql('DROP INDEX IDX_794381C6567F5183');
